...
export function TierBasedDashboardLayout({ children }: TierBasedDashboardLayoutProps) {
  ...
  const availableModules = userTier === "tier1" ? tier1Modules :
                          userTier === "tier2" ? tier2Modules : tier3Modules;
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="p-4 border-b border-neutral-200">
              <h2 className="text-lg font-semibold text-neutral-900">
                {userTier === "tier1" ? "Platform Admin" :
                 userTier === "tier2" ? "Organization" : "Employee"} Menu
              </h2>
              <p className="text-sm text-neutral-500 mt-1">
                {userTier === "tier1" ? "Manage entire platform" :
                 userTier === "tier2" ? "Manage your organization" : "Access your workspace"}
              </p>
            </div>

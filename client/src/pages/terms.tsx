          ...
          <Card className='mb-8'>
            <CardContent className='p-8'>
              ...
              <p className='text-neutral-600 leading-relaxed'>
                These Terms of Service ("Terms") govern your use of the BizHub platform and
                services. By using our services, you agree to these terms and our Privacy Policy. If
                you are using our services on behalf of a business, you represent that you have the
          ...
          <Card className='mt-12'>
            <CardContent className='p-8'>
              ...
              <div className='space-y-2 text-neutral-700'>
                <p>
                  <strong>Email:</strong> legal@bizhub.com
                </p>
                <p>

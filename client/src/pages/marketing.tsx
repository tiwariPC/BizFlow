...
export default function Marketing() {
    ...
    switch (type) {
      ...
      case 'deal':
        setDeals(deals.map(deal =>
          deal.id === id ? { ...deal, stage: newStatus } : deal
        ));
        break;
    }
  };
  ...
  const handleUpdateCampaign = () => {
    ...
    setCampaigns(campaigns.map(campaign =>
      campaign.id === editCampaignData.id ? editCampaignData : campaign
    ));
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-neutral-600">{messageTarget.email || messageTarget.phone}</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label>Opened</Label>
                  <p className="font-medium">{selectedCampaign.opened.toLocaleString()} ({calculateOpenRate(selectedCampaign)}%)</p>
                </div>
                <div>
                  <Label>Clicked</Label>
                  <p className="font-medium">{selectedCampaign.clicked.toLocaleString()} ({calculateClickRate(selectedCampaign)}%)</p>
                </div>
                <div>
                  <Label>Converted</Label>
                  <p className="font-medium">{selectedCampaign.converted.toLocaleString()} ({calculateConversionRate(selectedCampaign)}%)</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 border border-neutral-200 rounded-lg text-center">
                    <p className="text-2xl font-bold text-blue-600">{calculateOpenRate(selectedCampaign)}%</p>
                    <p className="text-sm text-neutral-600">Open Rate</p>
                  </div>
                  <div className="p-4 border border-neutral-200 rounded-lg text-center">
                    <p className="text-2xl font-bold text-green-600">{calculateClickRate(selectedCampaign)}%</p>
                    <p className="text-sm text-neutral-600">Click Rate</p>
                  </div>
                  <div className="p-4 border border-neutral-200 rounded-lg text-center">
                    <p className="text-2xl font-bold text-purple-600">{calculateConversionRate(selectedCampaign)}%</p>
              ...
              <div className="flex gap-2 pt-4">
                <Button onClick={() => setSelectedCampaign(null)} variant="outline" className="flex-1">
                  Close
                </Button>
                                <Button
                  className="flex-1"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 pt-4">
                <Button onClick={() => setShowEditCampaign(false)} variant="outline" className="flex-1">
                  Cancel
                </Button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 pt-4">
                <Button onClick={() => setShowWebsitePreview(false)} variant="outline" className="flex-1">
                  Close
                </Button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={() => setShowPostModal(false)} variant="outline" className="flex-1">
                  Cancel
                </Button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={() => setShowSchedulePost(false)} variant="outline" className="flex-1">
                  Cancel
                </Button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={() => setShowKeywordResearch(false)} variant="outline" className="flex-1">
                  Close
                </Button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={() => setShowSiteAudit(false)} variant="outline" className="flex-1">
                  Close
                </Button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label>Status</Label>
                <Badge className={selectedPost.status === 'Scheduled' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'}>
                  {selectedPost.status}
                </Badge>
              </div>
              <div>
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={handleUpdatePost} className="flex-1">Update Post</Button>
              </div>
            </div>
          </div>
        </div>

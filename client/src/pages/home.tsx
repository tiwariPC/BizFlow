...
import {
  Building2, Scale, Wrench, Banknote, TrendingUp, Network,
  LayoutDashboard, ShieldCheck, CheckCircle, Star, Users,
  Award, Zap, Headphones, ArrowRight, ChevronRight,
  Globe, Rocket, Target, Lightbulb, Clock, Shield
} from "lucide-react";
  ...
  const testimonials = [
    {
      ...
      content: "BizHub made our incorporation process seamless. The compliance tools are a lifesaver!",
      rating: 5,
      avatar: "👩‍💼"
    },
    {
      ...
      content: "The all-in-one platform helped us focus on growth while they handled the paperwork.",
      rating: 5,
      avatar: "👨‍💼"
    },
    {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center">
            ...
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-md rounded-full border border-white/30 mb-8 shadow-lg">
              ...
              <span className="text-sm font-semibold text-white">🚀 Launching Soon - Join the Revolution!</span>
            </div>
            ...
            <p className="text-xl md:text-2xl mb-10 text-blue-100 max-w-4xl mx-auto leading-relaxed font-medium">
              ...
              <span className="text-white font-semibold">Everything you need, all in one place.</span>
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                ...
                <div className="text-4xl md:text-5xl font-black text-gray-900 mb-3 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{stat.number}</div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We've designed every feature with entrepreneurs in mind, ensuring you have
              the tools and support needed to succeed in today's competitive market.
            </p>
          </div>
            ...
            {benefits.map((benefit, index) => (
              <div key={index} className="group relative">
                <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                  <div className={`w-24 h-24 bg-gradient-to-br ${benefit.gradient} rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg relative overflow-hidden`}>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Comprehensive tools and services designed to power your business growth
              ...
              <div key={index} className="group relative">
                <div className="bg-white rounded-3xl border border-gray-200 p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 h-full">
                  <div className="relative mb-6">
                    <div className={`w-20 h-20 bg-gradient-to-br ${module.color} rounded-3xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg relative overflow-hidden`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div key={index} className={`relative group ${
                ...
                <div className={`bg-white rounded-3xl border-2 p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 h-full ${
                    ...
                    <div className="bg-white rounded-3xl p-12 shadow-2xl border border-gray-100">
                      <div className="text-center">
                        ...
                        <div className="border-t border-gray-200 pt-8">
                          <p className="text-2xl font-black text-gray-900 mb-2">{testimonial.name}</p>
      ...
      <section className="py-32 bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-16 max-w-4xl mx-auto leading-relaxed font-medium">
            Join thousands of entrepreneurs who trust BizHub to help them build,

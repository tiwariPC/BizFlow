...
const steps = [
  { phase: "Incorporation", color: "text-blue-600", items: [
    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-10">
          ...
          <p className="text-neutral-600">Follow the step-by-step checklist from incorporation to launch and marketing</p>
        </div>

        <div className="space-y-8">
          {steps.map((group) => (
            <div key={group.phase} className="bg-white rounded-2xl border border-neutral-200 p-6 shadow-sm">
              ...
              <div className="space-y-3">
                {group.items.map((it) => (
                  ...
                  >
                    {completed[it.key] ? <CheckCircle2 className="w-5 h-5 text-emerald-600" /> : <Circle className="w-5 h-5 text-neutral-500" />}

          ...
          <Card className='mb-8'>
            <CardContent className='p-8'>
              ...
              <p className='text-neutral-600 leading-relaxed'>
                At BizHub, we are committed to protecting your privacy and ensuring the security of
                your personal and business information. This Privacy Policy explains how we collect,
                use, disclose, and safeguard your information when you use our platform and
                services.
              </p>
            </CardContent>
          </Card>

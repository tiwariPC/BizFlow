...
export default function Finance() {
  ...
  const generatePDF = (invoice: Invoice) => {
    try {
      ...
      doc.text(
        invoice.designData?.companyName || invoiceDesign.companyName || 'BizFlow Solutions',
        20,
        30,
      );
      ...
      doc.text(
        invoice.designData?.companyAddress ||
      ...
      doc.text(
        `Phone: ${invoice.designData?.companyPhone || invoiceDesign.companyPhone || '+1 (555) 123-4567'}`,
        20,
        45,
      );
      doc.text(
        `Email: ${invoice.designData?.companyEmail || invoiceDesign.companyEmail || 'info@bizflow.com'}`,
        20,
        50,
      );
      ...
      try {
        ...
        doc.text(
          `Tax (18%): ₹${(Number(invoice.amount) * 0.18).toLocaleString()}`,
          150,
          finalY + 10,
        );
        ...
        doc.text(
          `Total: ₹${(Number(invoice.amount) * 1.18).toLocaleString()}`,
          150,
          fallbackY + 20,
        );
      }
        ...
        try {
          ...
          try {
            ...
            try {
              ...
              alert(
                'PDF generated successfully but could not be downloaded. Please check your browser settings and try again.',
              );
            }
          }
        }
  ...
  const generateDesignerPDF = () => {
    ...
    doc.text(
      `Tax (${invoiceDesign.taxRate}%): ₹${invoiceDesign.taxAmount.toLocaleString()}`,
      150,
      finalY + 10,
    );
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-2xl font-bold text-neutral-900'>
                  ₹{(totalInvoices - totalExpenses).toLocaleString()}
                </p>
              </div>
                    ...
                    onChange={e => {
                      ...
                      if (searchTerm === '') {
                        ...
                        const storedInvoices = JSON.parse(
                          localStorage.getItem('bizflow_invoices') || '[]',
                        );
              ...
              <div className='space-y-4'>
                <div className='flex items-center justify-between'>
                  ...
                  <span className='font-semibold text-neutral-900'>
                    ₹{taxSummary.currentQuarter.gst.toLocaleString()}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-sm text-neutral-600'>TDS</span>
                  <span className='font-semibold text-neutral-900'>
                    ₹{taxSummary.currentQuarter.tds.toLocaleString()}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-sm text-neutral-600'>Income Tax</span>
                  <span className='font-semibold text-neutral-900'>
                    ₹{taxSummary.currentQuarter.incomeTax.toLocaleString()}
                  </span>
                </div>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <span className='text-lg font-bold text-neutral-900'>
                    ₹
                    {(
                      taxSummary.currentQuarter.gst +
                      taxSummary.currentQuarter.tds +
                      taxSummary.currentQuarter.incomeTax
                    ).toLocaleString()}
                  </span>
                </div>
              </div>
              ...
              <div className='space-y-3'>
                ...
                {isTier1Or2 ? (
                  <Button
                    className='w-full justify-start'
                    variant='outline'
                    onClick={() => setShowInvoiceDesigner(true)}
                  >
              ...
              <div className='flex items-center justify-between mb-6'>
                ...
                <div className='flex items-center gap-4'>
                  <div className='text-sm text-gray-600'>
                    <div>
                      Client:{' '}
                      <span className='font-medium'>{invoiceDesign.clientName || 'Not set'}</span>
                    </div>
                    <div>
                      Invoice #:{' '}
                      <span className='font-medium'>
                        {invoiceDesign.invoiceNumber || 'Not set'}
                      </span>
                    </div>
                    <div>
                      Due Date:{' '}
                      <span className='font-medium'>{invoiceDesign.dueDate || 'Not set'}</span>
                    </div>
                  </div>
                  ...
                  <div className='flex-1'>
                    <div className='mb-4'>
                      <Input
                        ...
                        onChange={e =>
                          setInvoiceDesign(prev => ({ ...prev, companyName: e.target.value }))
                        }
                    ...
                    <div className='mb-2'>
                      <Textarea
                        ...
                        onChange={e =>
                          setInvoiceDesign(prev => ({ ...prev, companyAddress: e.target.value }))
                        }
                    ...
                    <div className='text-sm text-gray-600 space-y-1'>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setInvoiceDesign(prev => ({ ...prev, companyPhone: e.target.value }))
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setInvoiceDesign(prev => ({ ...prev, companyEmail: e.target.value }))
                          }
                          className='ml-2 border-0 bg-transparent p-0 text-sm focus:ring-0 focus:border-b-2 focus:border-blue-500'
                    ...
                    <div className='space-y-2 text-sm'>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setInvoiceDesign(prev => ({ ...prev, invoiceNumber: e.target.value }))
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setInvoiceDesign(prev => ({ ...prev, issueDate: e.target.value }))
                          }
                          className='ml-2 border-0 bg-transparent p-0 text-sm focus:ring-0 focus:border-b-2 focus:border-blue-500'
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setInvoiceDesign(prev => ({ ...prev, dueDate: e.target.value }))
                          }
                          className='ml-2 border-0 bg-transparent p-0 text-sm focus:ring-0 focus:border-b-2 focus:border-blue-500'
                        />
                      </div>
                  ...
                  <div className='pl-4'>
                    <div className='mb-2'>
                      <Input
                        ...
                        onChange={e =>
                          setInvoiceDesign(prev => ({ ...prev, clientName: e.target.value }))
                        }
                    ...
                    <div className='mb-2'>
                      <Textarea
                        ...
                        onChange={e =>
                          setInvoiceDesign(prev => ({ ...prev, clientAddress: e.target.value }))
                        }
                        className='text-sm text-gray-600 border-0 bg-transparent p-0 resize-none focus:ring-0 focus:border-b-2 focus:border-blue-500'
                    ...
                    <div className='text-sm text-gray-600 space-y-1'>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setInvoiceDesign(prev => ({ ...prev, clientEmail: e.target.value }))
                          }
                          className='ml-2 border-0 bg-transparent p-0 text-sm focus:ring-0 focus:border-b-2 focus:border-blue-500'
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setInvoiceDesign(prev => ({ ...prev, clientPhone: e.target.value }))
                          }
                          className='ml-2 border-0 bg-transparent p-0 text-sm focus:ring-0 focus:border-b-2 focus:border-blue-500'
                        ...
                        <tr key={index} className='border-b border-gray-200'>
                          ...
                          <td className='py-3 px-4 text-center'>
                            <Input
                              ...
                              value={item.rate}
                              onChange={e =>
                                handleItemChange(index, 'rate', Number(e.target.value) || 0)
                              }
                              placeholder='0.00'
                ...
                <div className='flex justify-end mb-8'>
                  <div className='w-80 space-y-3'>
                    <div className='flex justify-between text-sm'>
                      ...
                      <span className='font-medium'>
                        ₹{invoiceDesign.subtotal.toLocaleString()}
                      </span>
                    </div>
                    <div className='flex justify-between text-sm'>
                      <span className='text-gray-600'>Tax ({invoiceDesign.taxRate}%):</span>
                      <span className='font-medium'>
                        ₹{invoiceDesign.taxAmount.toLocaleString()}
                      </span>
                    </div>
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={value => setBankForm(prev => ({ ...prev, accountType: value }))}
                  >
                    <SelectTrigger>
          ...
          >
            ...
            >
              <div className='flex items-center justify-between mb-6'>
                ...
                <Button variant='ghost' size='sm' onClick={() => setShowInvoiceDetailModal(false)}>
                  <X className='w-4 h-4' />
                </Button>
              </div>
          ...
          >
            ...
            >
              <div className='flex items-center justify-between mb-6'>
                ...
                <Button variant='ghost' size='sm' onClick={() => setShowInvoiceDesigner(false)}>
                  <X className='w-4 h-4' />
                </Button>
              </div>
                    ...
                    <div className='space-y-4'>
                      <div>
                        ...
                        <Textarea
                          value={invoiceDesign.notes}
                          onChange={e =>
                            setInvoiceDesign(prev => ({ ...prev, notes: e.target.value }))
                          }
                          className='ml-2 border-0 bg-transparent p-0 text-sm text-gray-600 resize-none focus:ring-0 focus:border-b-2 focus:border-blue-500'
                          placeholder='Additional notes...'
                          rows={2}
                      ...
                      <div>
                        ...
                        <Textarea
                          value={invoiceDesign.terms}
                          onChange={e =>
                            setInvoiceDesign(prev => ({ ...prev, terms: e.target.value }))
                          }
                          className='ml-2 border-0 bg-transparent p-0 text-sm text-gray-600 resize-none focus:ring-0 focus:border-b-2 focus:border-blue-500'
                          placeholder='Payment terms and conditions...'
                          rows={2}
                      ...
                      <CardContent className='space-y-4'>
                        <div>
                          ...
                          <Input
                            ...
                            onChange={e =>
                              setInvoiceDesign(prev => ({ ...prev, headerText: e.target.value }))
                            }
                        ...
                        <div>
                          ...
                          <div className='flex items-center gap-2'>
                            <Input
                              ...
                              onChange={e =>
                                setInvoiceDesign(prev => ({ ...prev, headerColor: e.target.value }))
                              }
                              className='w-16 h-10'
                            />
                            <Input
                      ...
                      <CardContent className='space-y-4'>
                        <div>
                          ...
                          <Textarea
                            ...
                            onChange={e =>
                              setInvoiceDesign(prev => ({ ...prev, footerText: e.target.value }))
                            }
                        ...
                        <div>
                          ...
                          <div className='flex items-center gap-2'>
                            <Input
                              ...
                              onChange={e =>
                                setInvoiceDesign(prev => ({ ...prev, footerColor: e.target.value }))
                              }
                              className='w-16 h-10'
                            />
                            <Input
                        ...
                        <div>
                          ...
                          <div className='flex items-center gap-2'>
                            <Input
                              ...
                              onChange={e =>
                                setInvoiceDesign(prev => ({ ...prev, accentColor: e.target.value }))
                              }
                              className='w-16 h-10'
                            />
                            <Input
                    ...
                    <CardContent>
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            setInvoiceDesign(prev => ({ ...prev, template: value }))
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
            ...
            >
              <div className='text-center mb-6'>
                ...
                <p className='text-gray-600'>
                  Invoice <span className='font-medium'>{lastCreatedInvoice.id}</span> has been
                  created and saved.
                </p>
              </div>
              ...
              <div className='space-y-3'>
                ...
                <Button onClick={() => setShowInvoiceSuccessModal(false)} className='w-full'>
                  Done
                </Button>
              </div>
            </motion.div>

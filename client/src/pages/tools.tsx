            ...
            <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredEmployees.map((employee) => (
                  <div key={employee.id} className="border border-neutral-200 rounded-lg p-6 bg-white">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="font-semibold text-neutral-900">₹{employee.salary.toLocaleString()}</p>
                      </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-neutral-900">{payrollSummary.totalEmployees}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-neutral-900">₹{payrollSummary.totalSalary.toLocaleString()}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-neutral-900">₹{payrollSummary.deductions.toLocaleString()}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-neutral-900">₹{payrollSummary.netPay.toLocaleString()}</p>
                  </div>
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select value={leaveForm.employee} onValueChange={(value) => setLeaveForm({...leaveForm, employee: value})}>
                <SelectTrigger>

...
import { Building2, Scale, Wrench, Banknote, TrendingUp, Network, LayoutDashboard, ShieldCheck, Palette, PenTool, Users, BookOpen } from "lucide-react";
...
const serviceCategories = [
  ...
  },
  {
    ...
    color: "purple",
    items: [
      { text: "On-demand graphic design services (flyers, posters, banners)", href: "/marketplace" },
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-8 flex-1">
                    {category.items.map((item, itemIndex) => (
                      <Link key={item.text} href={item.href}>
                        <div
                          className={`flex items-center gap-2 p-3 rounded-lg bg-white border border-neutral-200 hover:bg-neutral-50 hover:border-neutral-300 transition-colors duration-200 cursor-pointer shadow-sm`}
                        >

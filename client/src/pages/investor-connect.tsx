...
const fundingOpportunities: FundingOpportunity[] = [
  {
    ...
    description: 'Looking for B2B SaaS startups with proven product-market fit and scalable business model.'
  },
  {
    id: '2',
    ...
    description: 'Supporting early-stage fintech startups with innovative payment or lending solutions.'
  },
  {
    id: '3',
    ...
    description: 'Seeking manufacturing companies ready for national expansion and technology upgrade.'
  }
];
  ...
  return (
    <DashboardLayout>
      ...
      <div className="mb-8">
        ...
        <p className="text-neutral-600">Connect with investors, find funding opportunities, and prepare your pitch</p>
      </div>
              ...
              <div className="space-y-4">
                {investors.map((investor) => (
                  <div key={investor.id} className="border border-neutral-200 rounded-lg p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-start gap-4">
                        <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
                          <span className="font-semibold text-blue-600 text-lg">{investor.avatar}</span>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-neutral-600">Last active: {investor.lastActive}</span>
          ...
          <Card className="border-dashed border-2 border-neutral-300">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-sm text-neutral-600 mb-3">
                AI-powered pitch deck analysis, investor matching algorithm, and deal flow management coming soon!
              </p>

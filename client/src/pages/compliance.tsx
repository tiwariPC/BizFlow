...
export default function Compliance() {
  ...
  const [guidelines, setGuidelines] = useState([
    ...
    },
    {
      ...
      documents: ['PAN Card', 'Business Address Proof', 'Bank Account Details', 'Business Registration'],
      timeline: '7-15 days',
    ...
    },
    {
      ...
      documents: ['Financial Statements', 'Audit Reports', 'Tax Returns', 'Compliance Certificates'],
      timeline: 'Ongoing',
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-600">{complianceStatus.completedSteps}/{complianceStatus.totalSteps}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) => setReportForm(prev => ({ ...prev, includeDocuments: e.target.checked }))}
                    className="rounded"
                  />
              ...
              {!complianceCheck.results ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    This will analyze your current compliance status and identify any issues or missing requirements.
                  </p>
                  <Button
                  ...
                  {complianceCheck.results.recommendations.length > 0 && (
                    <div>
                      ...
                      <ul className="space-y-2">
                        {complianceCheck.results.recommendations.map((rec: string, index: number) => (
                  ...
                  {complianceCheck.results.nextDeadlines.length > 0 && (
                    <div>
                      ...
                      <div className="space-y-2">
                        {complianceCheck.results.nextDeadlines.map((deadline: any, index: number) => (

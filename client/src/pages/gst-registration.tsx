    ...
    >
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        ...
        <motion.div className='text-center mb-12' variants={itemVariants}>
          ...
          <h1 className='text-4xl md:text-5xl font-bold text-neutral-900 mb-4'>GST Registration</h1>
        ...
        >
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg text-neutral-700 mb-6'>
              GST registration is mandatory for businesses with annual turnover above ₹20 lakhs. It
              enables you to collect and claim GST, making your business compliant with tax laws.
            </p>

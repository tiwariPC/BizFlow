    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-2">Setup Your Dashboard</h1>
          <p className="text-neutral-600">Business type: <span className="font-medium">{businessType ?? 'Not selected'}</span></p>
        </div>

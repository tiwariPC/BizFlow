      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        ...
        >
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg text-neutral-700 mb-6'>
              Select the incorporation option that best fits your business needs and goals. Each
              structure offers different benefits in terms of liability, compliance, and growth
              potential.
            </p>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4'>
              {['Sole Prop', 'Partnership', 'LLP', 'OPC', 'Pvt Ltd', 'Public Ltd'].map(
                (type, index) => (
                  <motion.div
                    key={type}
          ...
          {isLoading ? (
            ...
            >
              {packages.map((pkg, index) => (
                ...
                >
                  <ServiceCard package={pkg} onSelect={handleServiceSelect} />
                </motion.div>
              ))}
            </div>
          )}
        ...
        <motion.div className='mt-16 text-center' variants={itemVariants}>
          <div className='max-w-3xl mx-auto'>
            <h3 className='text-2xl font-semibold text-neutral-900 mb-4'>Need Help Choosing?</h3>

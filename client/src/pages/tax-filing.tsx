        ...
        >
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg text-neutral-700 mb-6'>
              Our expert team ensures accurate tax filing, timely submissions, and maximum tax
              savings. We handle all types of tax returns with complete compliance.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Ensure timely and accurate filing',
                },
        ...
        <motion.div className='text-center' variants={itemVariants}>
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            {[
              ...
              <motion.div key={process.step} className='text-center' variants={itemVariants}>

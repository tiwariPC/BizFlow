                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                      <div className='flex items-center justify-between p-3 bg-neutral-50 rounded-lg'>
                        ...
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            handlePreferenceChange(preference.type, 'email', checked)
                          }
                        />
                      </div>
                      ...
                      <div className='flex items-center justify-between p-3 bg-neutral-50 rounded-lg'>
                        ...
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            handlePreferenceChange(preference.type, 'push', checked)
                          }
                        />
                      </div>
                      ...
                      <div className='flex items-center justify-between p-3 bg-neutral-50 rounded-lg'>
                        ...
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            handlePreferenceChange(preference.type, 'inApp', checked)
                          }
                        />
                      </div>
                    </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className='space-y-3 text-sm text-neutral-600'>
                ...
                <p>
                  <strong>Push:</strong> Get instant notifications on your device (requires
                  permission).
                </p>
                <p>
                ...
                <p>
                  <strong>Priority Levels:</strong> High priority notifications are always delivered

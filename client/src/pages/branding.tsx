...
export default function Branding() {
  ...
  const [selectedPrintType, setSelectedPrintType] = useState<
    'letterhead' | 'business-card' | 'envelope' | 'stamp' | null
  >(null);
  ...
  const updateLogoElement = (id: string, updates: Partial<LogoElement>) => {
    setLogoElements(prev => prev.map(el => (el.id === id ? { ...el, ...updates } : el)));
  };
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-neutral-600'>
                          {project.type} • {project.designer || project.writer || project.producer}
                        </p>
                      </div>
                    </div>
                    <div className='flex items-center gap-4'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <Card className='border-2 border-blue-200 hover:border-blue-300 transition-colors'>
                  <CardHeader>
                    ...
                    <p className='text-sm text-neutral-600'>
                      Let AI create a professional logo for you
                    </p>
                  </CardHeader>
                ...
                <Card className='border-2 border-green-200 hover:border-green-300 transition-colors'>
                  <CardHeader>
                    ...
                    <p className='text-sm text-neutral-600'>
                      Design your logo from scratch with full control
                    </p>
                  </CardHeader>
                  <CardContent className='space-y-4'>
                    <div className='space-y-3'>
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-neutral-600'>
                Manage your brand colors, fonts, assets, and guidelines
              </p>
            </div>
              ...
              {brandAssets.length === 0 ? (
                <div className='text-center py-8'>
                  ...
                  <p className='text-sm text-neutral-500'>
                    Add logos, icons, and other brand materials
                  </p>
                </div>
              ) : (
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                <div className='p-4 border border-neutral-200 rounded-lg'>
                  ...
                  <p className='text-sm text-neutral-600 mb-3'>
                    Generate designs with artificial intelligence
                  </p>
                  <Button
                    size='sm'
                    variant='outline'
                ...
                <div className='p-4 border border-neutral-200 rounded-lg'>
                  ...
                  <p className='text-sm text-neutral-600 mb-3'>
                    Pixel-perfect design with measurement tools
                  </p>
                ...
                <div className='p-4 border border-neutral-200 rounded-lg'>
                  ...
                  <p className='text-sm text-neutral-600 mb-3'>
                    Professional layout with grid alignment
                  </p>
                  <Button size='sm' variant='outline' className='w-full'>
                    Enable Grid
                  </Button>
        ...
        <div className='space-y-8'>
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-neutral-600'>
                Professional content creation and media production services
              </p>
            </div>
          </div>
              ...
              <Card key={service.id} className='hover:shadow-lg transition-shadow'>
                <CardContent className='p-6'>
                  ...
                  <div className='flex gap-2'>
                    <Button
                      className='flex-1'
                      onClick={() => alert(`Requesting ${service.name} service...`)}
                    >
                      Request Service
                    </Button>
            ...
            <CardContent>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <div>
                  ...
                  <Input type='number' placeholder='e.g., 500 words' className='w-full' />
                </div>
                ...
                <div className='md:col-span-2'>
                  <Button
                    ...
                    onClick={() => alert('Content request submitted successfully!')}
                  >
                    <Plus className='w-4 h-4 mr-2' />
                    Submit Request
                  </Button>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                  {printTemplates.map(template => (
                    ...
                    >
                      <div className='flex items-center gap-3 mb-3'>
                        <div className='w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center'>
                          {template.type === 'letterhead' && (
                            <FileText className='w-6 h-6 text-blue-600' />
                          )}
                          {template.type === 'business-card' && (
                            <CreditCard className='w-6 h-6 text-blue-600' />
                          )}
                          {template.type === 'envelope' && (
                      ...
                      <div className='flex gap-2'>
                        <Button
                          ...
                          variant='outline'
                          className='flex-1'
                          onClick={() => exportPrintTemplate(template)}
                        >
                          <Download className='w-3 h-3 mr-1' />
                          Export
                        </Button>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                <div className='p-4 border border-neutral-200 rounded-lg'>
                  ...
                  <div className='space-y-1 text-sm text-neutral-600'>
                    ...
                    <p>
                      <strong>Paper:</strong> Premium White (100gsm)
                    </p>
                    <p>
                      <strong>Quantity:</strong> 500 sheets
                    </p>
                    <p>
                      <strong>Color:</strong> Full Color
                    </p>
                  </div>
                </div>
                ...
                <div className='p-4 border border-neutral-200 rounded-lg'>
                  ...
                  <div className='space-y-1 text-sm text-neutral-600'>
                    <p>
                      <strong>Size:</strong> Standard (85 x 55 mm)
                    </p>
                    <p>
                      <strong>Paper:</strong> Premium Card Stock (350gsm)
                    </p>
                    <p>
                      <strong>Quantity:</strong> 1000 cards
                    </p>
                    <p>
                      <strong>Color:</strong> Full Color
                    </p>
                ...
                <div className='p-4 border border-neutral-200 rounded-lg'>
                  ...
                  <div className='space-y-1 text-sm text-neutral-600'>
                    <p>
                      <strong>Size:</strong> DL (110 x 220 mm)
                    </p>
                    <p>
                      <strong>Paper:</strong> Premium White (90gsm)
                    </p>
                    <p>
                      <strong>Quantity:</strong> 500 envelopes
                    </p>
                    <p>
                      <strong>Color:</strong> Full Color
                    </p>
                ...
                <div className='p-4 border border-neutral-200 rounded-lg'>
                  ...
                  <div className='space-y-1 text-sm text-neutral-600'>
                    <p>
                      <strong>Size:</strong> Custom (40 x 40 mm)
                    </p>
                    <p>
                      <strong>Material:</strong> Rubber Stamp
                    </p>
                    <p>
                      <strong>Quantity:</strong> 1 stamp
                    </p>
                    <p>
                        ...
                        {logoElements.find(el => el.id === selectedElement)?.type === 'text' && (
                          <>
                            <div>
                              ...
                              <Input
                                value={
                                  logoElements.find(el => el.id === selectedElement)?.properties
                                    .text || ''
                                }
                                onChange={e =>
                                  updateLogoElement(selectedElement, {
                                    properties: {
                                      ...logoElements.find(el => el.id === selectedElement)
                                        ?.properties,
                                      text: e.target.value,
                                    },
                                  })
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value: any) =>
                      setNewColor(prev => ({ ...prev, category: value }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value: string) =>
                      setNewFont(prev => ({ ...prev, category: value }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
            ...
            >
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <Select
                    value={newAsset.type}
                    onValueChange={(value: any) => setNewAsset(prev => ({ ...prev, type: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
              ...
              <div className='flex items-center justify-between p-6 border-b'>
                <div>
                  <h2 className='text-2xl font-bold'>
                    Print Designer -{' '}
                    {selectedPrintType.charAt(0).toUpperCase() +
                      selectedPrintType.slice(1).replace('-', ' ')}
                  </h2>
                  <p className='text-neutral-600'>
                    Design your professional {selectedPrintType.replace('-', ' ')}
                  </p>
                </div>
                <div className='flex items-center gap-2'>
                    ...
                    <div className='space-y-3'>
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            setPrintSpecifications(prev => ({ ...prev, size: value }))
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                          ...
                          <SelectContent>
                            {selectedPrintType === 'letterhead' && (
                              <>
                                ...
                                <SelectItem value='Letter (216 x 279 mm)'>
                                  Letter (216 x 279 mm)
                                </SelectItem>
                                <SelectItem value='Legal (216 x 356 mm)'>
                                  Legal (216 x 356 mm)
                                </SelectItem>
                              </>
                            )}
                            {selectedPrintType === 'business-card' && (
                              <>
                                <SelectItem value='Standard (85 x 55 mm)'>
                                  Standard (85 x 55 mm)
                                </SelectItem>
                                <SelectItem value='Square (85 x 85 mm)'>
                                  Square (85 x 85 mm)
                                </SelectItem>
                                <SelectItem value='European (85 x 55 mm)'>
                                  European (85 x 55 mm)
                                </SelectItem>
                              </>
                            )}
                            ...
                            {selectedPrintType === 'stamp' && (
                              <>
                                <SelectItem value='Custom (40 x 40 mm)'>
                                  Custom (40 x 40 mm)
                                </SelectItem>
                                <SelectItem value='Large (50 x 50 mm)'>
                                  Large (50 x 50 mm)
                                </SelectItem>
                                <SelectItem value='Small (30 x 30 mm)'>
                                  Small (30 x 30 mm)
                                </SelectItem>
                              </>
                            )}
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            setPrintSpecifications(prev => ({ ...prev, paper: value }))
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                          ...
                          <SelectContent>
                            {selectedPrintType === 'letterhead' && (
                              <>
                                <SelectItem value='Premium White (100gsm)'>
                                  Premium White (100gsm)
                                </SelectItem>
                                <SelectItem value='Bond Paper (80gsm)'>
                                  Bond Paper (80gsm)
                                </SelectItem>
                            ...
                            {selectedPrintType === 'business-card' && (
                              <>
                                <SelectItem value='Premium Card Stock (350gsm)'>
                                  Premium Card Stock (350gsm)
                                </SelectItem>
                                <SelectItem value='Matte Finish (300gsm)'>
                                  Matte Finish (300gsm)
                                </SelectItem>
                                <SelectItem value='Glossy Finish (350gsm)'>
                            ...
                            {selectedPrintType === 'envelope' && (
                              <>
                                <SelectItem value='Premium White (90gsm)'>
                                  Premium White (90gsm)
                                </SelectItem>
                                <SelectItem value='Kraft Paper (80gsm)'>
                                  Kraft Paper (80gsm)
                                </SelectItem>
                            ...
                            {selectedPrintType === 'stamp' && (
                              <>
                                <SelectItem value='Rubber Stamp Material'>
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            setPrintSpecifications(prev => ({ ...prev, color: value }))
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                ...
                <div className='flex-1 p-6'>
                  <div className='h-full flex flex-col'>
                            ...
                            <div className='absolute top-48 left-8 right-8 bottom-8'>
                              <div className='border-l-4 border-blue-600 pl-4'>
                                <p className='text-lg font-medium mb-4'>
                                  Sample Letterhead Content
                                </p>
                                <p className='text-neutral-700 mb-2'>
                                  This is where your letter content would appear.
                                </p>
                                <p className='text-neutral-700 mb-2'>
                                  The design includes your company branding and contact information.
                                </p>
                                <p className='text-neutral-700'>
                                  Professional and clean layout for business correspondence.
                                </p>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className='flex items-center justify-between'>
                      <div className='text-sm text-neutral-600'>
                        <p>
                          <strong>Size:</strong> {printSpecifications.size}
                        </p>
                        <p>
                          <strong>Paper:</strong> {printSpecifications.paper}
                        </p>
                        <p>
                          <strong>Quantity:</strong> {printSpecifications.quantity}
                        </p>
                      </div>
                      <div className='flex gap-2'>
                        <Button

    ...
    <DashboardLayout>
      ...
      <div className='mb-8'>
        <h1 className='text-3xl font-bold text-neutral-900 mb-2'>
          {activeTab === 'knowledge' ? 'Knowledge Hub' : 'Community'}
        </h1>
        <p className='text-neutral-600'>
          {activeTab === 'knowledge'
            ? 'Learn, grow, and succeed with our comprehensive resources'
            : 'Connect with entrepreneurs, share experiences, and get expert advice'}
        </p>
      </div>
